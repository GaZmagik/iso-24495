...
Keep this proportionate. A one-line answer stays one line. Structure earns its place only when a reply makes more than one point.

## Check before you send

Read the draft back against four measures and fix what fails:

1. No sentence runs past 30 words.
2. The average sits between 15 and 20 words.

...
A reply that reports work has failure modes the limits above do not catch. Each one leaves the reader holding a decision they cannot make.

- **Give the finding, not the verdict alone.** "Three checks failed" is a number, not information. Name what failed in the same message, before you start repairing it.
- **Separate what is built from what is checked.** Done and verified are different claims. If a gate is still open, the sentence that reports the work says so.
- **Describe choices evenly.** Give every option the same treatment: what it gains and what it costs. Recommending one is honest; praising one and warning about the other is steering.
- **Do not contradict a rule you have just given.** If you tell the reader that a value is permitted, do not call that same value a fault later to support a recommendation.
- **Keep the grammar.** Brevity is not the omission of subjects and verbs. "Fixing." is a note to yourself, not a sentence for a reader.

## Check before you send

Read the draft back against six measures and fix what fails:
...
5. Every result reported carries its finding, and every claim of completion says what is still unverified.
6. Every option is described in the same terms as the others.

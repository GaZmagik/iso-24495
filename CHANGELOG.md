...
- Sentence rules recalibrated against public guidance and measured data. The engine now flags a document average above 20 words (new `sentence-average` rule, minimum sample 10 sentences) and raises the per-sentence cap from 20 to 30. The public standards (Cutts, Crystal Mark, Clear English Standard) specify an average of 15 to 20 words, not a per-sentence cap; measurement showed 60% of old flags were 21-to-29-word sentences in documents whose averages already complied.

...
After:  ## Summary of your main terms
        ...
        The binding text starts at clause 9.1 below, and it governs.
...
The summary in the "before" keeps the first and fourth terms and drops the other four. The "after" adds no term. Its one other sentence says where the binding text starts and that it governs.

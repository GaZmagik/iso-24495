...
A summary that drops a condition changes what the reader believes their rights are. A summary must also say that the agreement governs and name where that agreement starts.

```text
Before: 9.1 Notwithstanding any provision herein to the contrary, the Customer
            shall be entitled to terminate this Agreement by furnishing to the
            Supplier not less than 30 days' prior written notice of termination,
            whereupon the Supplier shall be obligated to refund to the Customer
            such proportion of the fees theretofore paid by the Customer as
            corresponds to the unexpired portion of the term, calculated on a
            pro-rata basis.

        Summary: You can end the Agreement and get your money back.
After:  ## Summary of your main terms

        The agreement governs these terms. The binding terms start at clause 9.1
        below.

        - **Ending the Agreement:** You may end this Agreement by giving the
          Supplier at least 30 days' written notice, as clause 9.1 sets out.
        - **Refund:** If you end the Agreement, the Supplier must refund the fees
          you have paid for the part of the term that has not yet run, calculated
          on a pro-rata basis, as clause 9.1 sets out.
```

The summary in the "before" drops the 30-day notice and the pro-rata qualification. The "after" keeps both, and it names clause 9.1 as where the binding terms start.
